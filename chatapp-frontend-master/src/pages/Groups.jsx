...
const Groups = () => {
  ...
  return myGroups.isLoading ? <LayoutLoader /> : (
    <Grid container height={"100dvh"} sx={{ overflow: "hidden" }}>
      ...
      <Grid item xs={12} sm={8} md={9} sx={{
        ...
        <Box sx={{
          ...
          flexShrink: 0,
          paddingTop: { xs: "max(1.25rem, calc(env(safe-area-inset-top) + 0.5rem))", sm: "1.25rem" },
        }}>
        ...
        {groupName ? (
          <Box sx={{ display: "flex", flexDirection: "column", alignItems: "center", p: { xs: 2, sm: 3 }, gap: 2.5, flex: 1, overflowY: "auto", minHeight: 0 }}>
            {/* Group avatar */}
            <Box sx={{
      ...
      <Drawer sx={{ display: { xs: "block", sm: "none" } }}
        ...
        PaperProps={{ sx: { bgcolor: "#ffffff", width: "80vw", maxWidth: 320, height: "100%" } }}
      >
...
const GroupsList = ({ w = "100%", myGroups = [], chatId }) => (
  <Stack width={w} height="100%" sx={{ overflowY: "auto", minHeight: 0 }}>
    {/* Header */}
